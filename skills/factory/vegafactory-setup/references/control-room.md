...
5. `gh project field-create <n> --owner <org> --name Status --data-type SINGLE_SELECT --single-select-options "waiting-on-operator,planning,ready,working,ready-to-ship,Done"` — the five state labels plus Done, in that order.
