...
import { latestPublishedVersion, maintainSelfUpdate, packageVersion, semverLess } from './self-update.ts'

type Agent = 'codex' | 'claude'
type AgentChoice = Agent | 'both'
type Mode = 'project' | 'global'
type Command = 'add' | 'update' | 'self-update' | 'verify' | 'doctor' | 'remove' | 'list' | 'version' | 'help' | 'worktree' | 'sync' | 'hook' | 'ship' | 'issue' | 'init' | 'agent' | 'stats' | 'dashboard' | 'learning' | 'review' | 'dispatch'
