...
Recover approved work by exact task and canonical source identity, preserving completed work, interrupted attempts and pending delivery.
...
- Construct and read back every same-home or remote-only attempt before starting the parent, re-resolve machine enrollment for every later action, and resume a partially started group without another transfer or start while reusing accepted results and joins without process, check or merge replay.
